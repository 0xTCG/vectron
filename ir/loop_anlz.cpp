...
void LoopAnalyzer::transform(ImperativeForFlow *v) {
    ...
    auto att_att = util::hasAttribute(pf, "std.vectron.dispatcher.scheduler");
    ...
    if (att_att){
        ...
        if (op == "max" || op == "min"){
            ...
            if (arg1_inst == NULL){
                ...
                auto max_att_1 = util::hasAttribute(max_st_1, "std.vectron.dispatcher.max");
            ...
            if (arg2_inst == NULL){
                ...
                auto max_att_2 = util::hasAttribute(max_st_2, "std.vectron.dispatcher.max");
            ...
            if (main_args == 0){
                ...
                if (arg3_inst == NULL){
                    ...
                    auto max_att_3 = util::hasAttribute(max_st_3, "std.vectron.dispatcher.max");
            ...
            if (arg1_inst == NULL){
                ...
                auto max_att_4 = util::hasAttribute(max_st_4, "std.vectron.dispatcher.max");
                if(max_att_4){
                    params_12 = "0";
                    params_13 = "0";
                    params_14 = "0";
                    ...
                    if (arg1_func_name == "__add__" || arg1_func_name == "__sub__" || arg1_func_name == "__mul__" || arg1_func_name == "__div__"){
                        ...
                        if (arg1_func_name == "__sub__"){
                            ...
                            if (cast<CallInstr>(arg1_const) == NULL){
                                ...
                                auto match_att_1 = util::hasAttribute(m_call_1_func, "std.vectron.dispatcher.cmp");
                                if (match_att_1){
            ...
            if (arg2_inst == NULL){
                ...
                auto max_att_5 = util::hasAttribute(max_st_5, "std.vectron.dispatcher.max");
                if(max_att_5){
                    params_18 = "0";
                    params_19 = "0";
                    params_20 = "0";
                    ...
                    if (arg2_func_name == "__add__" || arg2_func_name == "__sub__" || arg2_func_name == "__mul__" || arg2_func_name == "__div__"){
                        ...
                        if (arg2_func_name == "__sub__"){
                            ...
                            if (cast<CallInstr>(arg2_const) == NULL){
                                ...
                                auto match_att_2 = util::hasAttribute(m_call_2_func, "std.vectron.dispatcher.cmp");
                                if (match_att_2){
            ...
            if (main_args != 0){
                ...
                if (arg3_inst == NULL){
                    ...
                    auto max_att_6 = util::hasAttribute(max_st_6, "std.vectron.dispatcher.max");
                    if(max_att_6){
                        params_24 = "0";
                        params_25 = "0";
                        params_26 = "0";
                        ...
                        if (arg3_func_name == "__add__" || arg3_func_name == "__sub__" || arg3_func_name == "__mul__" || arg3_func_name == "__div__"){
                            ...
                            if (arg3_func_name == "__sub__"){
                                ...
                                if (cast<CallInstr>(arg3_const) == NULL){
                                    ...
                                    auto match_att_3 = util::hasAttribute(m_call_3_func, "std.vectron.dispatcher.cmp");
                                    if (match_att_3){
        ...
        if(arg1_inst != NULL){
            ...
            max_att_7 = util::hasAttribute(max_st_7, "std.vectron.dispatcher.max");
        }
        ...
        if (arg2_inst != NULL){
            ...
            max_att_8 = util::hasAttribute(max_st_8, "std.vectron.dispatcher.max");
        }
        ...
        if (r_end != r_mid[1]){
            ...
            if(arg3_inst != NULL){
                ...
                max_att_9 = util::hasAttribute(max_st_9, "std.vectron.dispatcher.max");
            }
